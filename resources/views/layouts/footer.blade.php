      <style>.infosGRP{position: fixed;bottom: 5px;left: 96.5vw;display: flex;justify-content:center;align-items: center;transition: left 0.5s ;}.infosGRP:hover{left: 1vw;}</style>
      <span class="infosGRP">
        <span style="width: 3.5vw; font-size: 25px;"><i class="fa-solid fa-circle-info"></i></span>
        <span style="width: 100vw; text-align: center;"> © 2023 - Projet info par <b>Aymene (5221357), Eren (2212662), Lucas (n° etu), Lilian (n° etu), Daniel (n° etu)</b> </span>
      </span>
    </body>
